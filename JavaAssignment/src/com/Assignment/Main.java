...
public class Main {
	...
	public Main (float temperature, boolean cough, boolean travelDanger, boolean covid19)
	{
	...
	public Main (float temperature, boolean cough, boolean achesPains, boolean soreThroat, boolean travelDanger, boolean covid19)
	{
		setTemperature(temperature);
		setCough(cough);

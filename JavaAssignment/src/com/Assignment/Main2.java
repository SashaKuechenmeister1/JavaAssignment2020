...
public class Main2 {
	...
	public Main2 (float temperature, boolean cough, boolean travelDanger, boolean covid19)
	{
	...
	public Main2 (float temperature, boolean cough, boolean achesPains, boolean soreThroat, boolean travelDanger, boolean covid19)
	{
		setTemperature(temperature);
		setCough(cough);
	...
	public void setAchesPains(String achesPains) {
		if (achesPains.equals("yes")) this.achesPains = true;
		else this.achesPains = false;
	}
	...
	public void setTravelDanger(String travelDanger) {
		if(travelDanger.equals("yes")) this.travelDanger = true;
		else this.travelDanger = false;
	}
